        ...
        <section id="extra" className="extra-section container">
            ...
            <div className="extra-cards">
                <ExtraCard
                    ...
                    // date="June 2023"
                    description="Secured 1st place competing against 20+ students by developing a live and on-demand video streaming platform for <a target='_blank' href='https://www.youtube.com/@EOTCMK' style='color: green;display:inline-block;'>Mahibere Kidusan Tv</a>."
                    imageUrl={mkIctLogo}
                />
                <ExtraCard
